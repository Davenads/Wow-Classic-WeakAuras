-- Trinket Display — Slot 1 (inventory slot 13) — Trigger ▸ Custom ▸ Trigger State Updater
-- Shows the live-equipped trinket in slot 13 with its cooldown swipe + number.
