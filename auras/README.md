...
| Betty's 19 Shaman Cooldowns | [Shaman/ShamanCooldowns](Shaman/ShamanCooldowns) | Era / SoD / HC | nested group: Tier 1 dyn (5 × 40px) + Tier 2 dyn (2 × 24px) + presence dyn (2 × 16px) | — | Import-ready (fabricated string, round-trip lossless); level 19 Tauren Shaman row — Tier 1 (War Stomp/Earth Shock/Earthbind 15s/Healing Potion 929/Big Bronze Bomb 4380), Tier 2 (Fire Nova 15s/Stoneclaw 30s), presence dots (Tremor/Searing); spells/totems by name, items possession-gated, Earthbind/Fire Nova/Stoneclaw glow while planted; pending in-game test |
