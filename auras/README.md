...
| Dwarf Priest Cooldowns | [Priest/PriestCooldowns](Priest/PriestCooldowns) | Era | dynamic group of 9 icons | — | Import-ready (generated string, round-trip lossless); level 60 Dwarf Priest row (Fade/Psychic Scream/Fear Ward/Desperate Prayer/Stoneform/Inner Focus/Mind Blast/Major Mana Potion/Mana Rune); spells by name, items possession-gated, Mind Blast reveals only on Shadow builds, hidden icons collapse; pending in-game test |
